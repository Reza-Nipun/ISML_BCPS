...
$top = $top+4.3;
	$pdf->MultiCell(35, 4.5, 'Lot No: '.$LotNo[$j], 0, 'L', 0, 0, 1.2, $top, true, 0, false, true, 4.5, 'L', true);
	$pdf->SetFont('times', '', 9);
...
$top2 = $top2+4.3;
	$pdf->MultiCell(35, 4.5, 'Lot No: '.$LotNo[$j], 0, 'L', 0, 0, 110, $top2, true, 0, false, true, 4.5, 'L', true);
	$pdf->SetFont('times', '', 9);
