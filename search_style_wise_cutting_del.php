...
?>
    ...
    table.bottomBorder2 td, table.bottomBorder2 th { border-bottom:1px dotted black;padding:1px;
    /*font-size:13px;*/
    font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;
    }
    table.bottomBorder2 tr { border:1px dotted black;padding:1px; }
	table.bottomBorder2 th { font-size:14px; }
	table.bottomBorder2 td { font-size:13px; }
...
<div class="row">
    ...
    <table id="example" border="1" class="bottomBorder">
        <tr>
        	<td>Style No</td>
              <td><select name="style" id="style" class="form-control" tabindex="1" required autofocus>
                    <option selected value="<?php echo $s_style; ?>"><?php echo $s_style; ?></option>
					<?php
                    ...
                    {
                    ?>
                    <option value="<?php echo $row['StyleCode']; ?>"><?php echo $row['StyleCode']; ?></option>
                    <?php
                    }
                    ?>
                </select></td>
            ...
            <td><select name="color" class="form-control" tabindex="2" id="color" >
                  <option selected="selected" value="">-Select Color-</option>
                    <option selected value="<?php echo $s_color; ?>"><?php echo $s_color; ?></option>
...
<div class="row">
 ...
 <br/>           
<span style="font-size:15px; font-weight:bold; color:#060; margin-left:30px">Cutting Summary of Style <?php echo $s_style; ?> &#10137;</span>
               <br/><br/> 
            ...
            <thead>
                ...
                <?php
                   ...
                   $SQL .= " GROUP BY Color ORDER BY Color ASC";
	...
	<?php if($sl%2=='0') { ?>
    <tr bgcolor="#F4F4F4" id="<?php echo $row['StyleCode'].'~'.$row['Color'] ; ?>" class="edit_tr">
      <?php } else { ?>
    <tr id="<?php echo $row['StyleCode'].'~'.$row['Color'] ; ?>" class="edit_tr">
      <?php } ?>    
