     ...
     <br />
     	<table class="bottomBorder" border="1">
        	<tr>
            	...
            	<th><span style="text-align:right; font-size:18px; font:'Comic Sans MS', cursive ">Color:</span> <span style="color:#F00">*</span></th>
	   ...
	   ?>
                ...
                <td><input type="text" name="unit" value="<?php echo $user_unit; ?>" tabindex="6" size="6" placeholder="Unit" readonly required autofocus ></td>            
            </tr>
            <!--<tr>
    ...
    <table class="bottomBorder" id="size_mrkr" style="box-shadow:0px 0px 0px 0px #FFF ;" border="1">
      ...
      <?php         
		...
		while($row2 = mysql_fetch_array($result2))
          ...
          <td><input name="size[]" type="text" value="'.$data.'" onclick="select()" tabindex="11" size="8" placeholder="Size" required autofocus /></td>
          ...
          <td><input name="lot_no[]" class="ins_lot_no" type="text" onclick="select()" tabindex="14" size="10" placeholder="Lot No" /></td>
				</tr>';
