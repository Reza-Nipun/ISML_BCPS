    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
             <form name="form1" id="form1" action="search_style_wise_cutting_v2.php" method="post" class="form-inline" role="form">
...
<div class="row">
 ...
 <br/>           
<span style="font-size:15px; font-weight:bold; color:#0F9; margin-left:30px">Cutting Summary of Style <u><?php echo $s_style; ?></u> &#10137;</span>
               <br/><br/> 
