...
$top = $top+4.3;
	...
	$pdf->SetFont('times', 'B', 9);
	$pdf->MultiCell(32, 4.5, 'Lot No: '.$LotNo[$j].'/ tNo-'.$RollNo[$j], 0, 'L', 0, 0, 34, $top, true, 0, false, true, 4.5, 'L', true);
...
$top2 = $top2+4.3;
	...
	$pdf->SetFont('times', 'B', 9);
		$pdf->MultiCell(32, 4.5, 'Lot No: '.$LotNo[$j].'/ tNo - '.$RollNo[$j], 0, 'L', 0, 0, 142.8, $top2, true, 0, false, true, 4.5, 'L', true);
